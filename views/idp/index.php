						...
						<div class="widget-body no-padding">
							<table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%">
								...
								<tbody>
						            ...
						            <tr>
						                <td><?=$model->id?></td>
										<td><?= Html::a($model->name,['idp/view','id' => $model->id],['target' => '_self']);?></td>
								        <td><?=$model->date_idp?></td>
								        <td><?=$model->date_idp_end?></td>
								        <td>
											<a herf= "#" class="btn btn-warning act-update" data-id=<?=$model->id?>><i class="fa fa-pencil-square-o"></i> แก้ไข</a>
											<a herf= "#" class="btn btn-info act-view" data-id=<?=$model->id?>><i class="fa fa-eye"></i> ดู</a>
											<?= Html::a('<i class="fa fa-remove"></i> ลบ',['idp/delete','id' => $model->id],
													[
