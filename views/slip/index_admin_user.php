							...
							<table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%">
								...
								<tbody>  
						            ...
						            <tr>
										...
										<td>
											<a href="#" class="act-update-u btn btn-info btn-xs" data-id=<?= $modelUser->id ?>> แกไข </a>
											<a href="<?= Url::to(['slip/delete_user','id' => $modelUser->id]) ?>" 
												class = "btn btn-info btn-xs" 
												data-id=<?= $modelUser->id ?> data-method="POST" 
												data-confirm="Are you sure to delete this item?"> ลบ </a>
										</td>
